...
export default async function handler(req, res) {
  ...
  async function putMethod() {
    try {
      ...
      res
        .status(500)
        .send(`PUT /api/apeakers/${id}  status: 500 unexpected error`);
      console.log(`PUT /api/apeakers/${id}  error: `, e);
    }
  }
  ...
  async function postMethod() {
    try {
      ...
      res
        .status(500)
        .send(`POST /api/apeakers/${id}  status: 500 unexpected error`);
      console.log(`POST /api/apeakers/${id}  error: `, e);
    }
  }
  ...
  async function deleteMethod() {
    try {
      ...
      res
        .status(500)
        .send(`DELETE /api/apeakers/${id}  status: 500 unexpected error`);
      console.log(`DELETE /api/apeakers/${id}  error: `, e);
    }
  }
}
